...
- [x] **DSGN-01**: Site has responsive layout that works on mobile, tablet, and desktop
- [x] **DSGN-02**: Neobrutalist styling with bold black borders and chunky shadows
- [x] **DSGN-03**: Custom color palette derived from reference images (dusty pinks, teals, golds, space blacks)
- [x] **DSGN-04**: Subtle Norse geometric accents in borders, dividers, and decorative elements
- [x] **DSGN-05**: All color combinations pass WCAG AA contrast requirements
...
- [x] **NAV-01**: Clear navigation to all main sections (Home, Blog, Projects, About)
- [x] **NAV-02**: Navigation reinforces the brand identity
- [x] **NAV-03**: Mobile navigation works intuitively

### Home Page

- [x] **HOME-01**: Bold, minimal landing page with name and tagline
- [x] **HOME-02**: Design itself makes the statement (no featured content needed)
- [x] **HOME-03**: Clear path to discover content via navigation
...
- [x] **ABUT-03**: Downloadable PDF resume (placeholder implemented)
...
**Shipped:** 30 of 31 v1 requirements
**Adjusted:** None
**Dropped:** 1 (INTR-02 - View Transitions API experimental, deferred to v2)
