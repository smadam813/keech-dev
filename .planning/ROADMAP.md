...
- ✅ **v1.8.1 Address Missed Concerns** — Phase 24 (shipped 2026-04-11)
...
<details>
<summary>✅ v1.8.1 Address Missed Concerns (Phase 24) — SHIPPED 2026-04-11</summary>

- [x] Phase 24: Audit Gap Closures (3/3 plans) — completed 2026-04-12

See: `.planning/milestones/v1.8.1-ROADMAP.md` for full details.
