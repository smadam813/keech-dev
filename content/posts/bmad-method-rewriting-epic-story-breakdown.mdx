...
I have had a complicated relationship with story points for years. They feel useful in the moment but rarely produce the predictability they promise. So I noticed something telling when I started evaluating agent-driven frameworks: BMAD does not include estimation. Neither does [GitHub's Spec Kit](https://github.com/github/spec-kit). Neither does [AWS Kiro](https://kiro.dev/). The three major spec-driven development tools all omit story points entirely. This is not an oversight. It is a design choice rooted in a decades-old debate that agent-driven workflows may finally resolve.

[Ron Jeffries](https://ronjeffries.com/articles/019-01ff/story-points/Index.html), who likely invented story points, wrote in 2019: "I may have invented story points, and if I did, I'm sorry now." His regret was specific. Story points were designed as a simple capacity planning tool and evolved into a pervasive measurement and control mechanism. [Allen Holub argues](https://holub.com/noestimates-an-introduction/) they were originally created to "obfuscate duration so that certain managers would not pressure the team over estimates."
...
This aligns with [Vasco Duarte's #NoEstimates research](https://oikosofyseries.com/), which demonstrated that simple story counts predict delivery timelines as accurately as story point totals when stories are sliced to uniform size. The math is unambiguous: count stories remaining, divide by completion rate, get a delivery date. No planning poker required.
...
Planning poker is not just an estimation technique. [Scrum.org states](https://www.scrum.org/resources/blog/product-backlog-refinement-how-succeed-scrum-team) its purpose is "understanding whether we are all on the same page about the why, the what, and the how as a team." The ritual ensures every team member is involved, multiple viewpoints surface, and consensus is reached deliberately. It gives junior developers a structured venue to ask questions about the codebase. It forces senior engineers to articulate assumptions they would otherwise keep implicit.

**Psychological safety is the mediating factor.** [Google's Project Aristotle](https://rework.withgoogle.com/intl/en/guides/understanding-team-effectiveness) studied 180 teams and found psychological safety predicted team effectiveness better than talent or process maturity. A [2025 study of 318 software professionals](https://www.tandfonline.com/doi/full/10.1080/1359432X.2025.2508178) found psychological safety is "the mediating factor that makes standups actually work." [Gallup data](https://www.gallup.com/workplace/236198/create-culture-psychological-safety.aspx) shows 27% lower turnover on psychologically safe teams, and research consistently links psychological safety to significantly higher engagement.
...
Spec-driven development has a cost, and I think it is important to be honest about that. [Scott Logic benchmarked](https://blog.scottlogic.com/2025/11/26/putting-spec-kit-through-its-paces-radical-idea-or-reinvented-waterfall.html) GitHub's Spec Kit and found it produced 2,577 lines of markdown for 689 lines of code, running 7.5x slower than iterative prompting (roughly 4 hours vs. 32 minutes). [Marmelab's evaluation](https://marmelab.com/blog/2025/11/12/spec-driven-development-waterfall-strikes-back.html) generated 8 files and 1,300 lines of specification text for a feature that displays a date. Their verdict: "mostly unusable" for large existing codebases.
...
[Martin Fowler observed](https://www.artima.com/intv/evolution.html) that upfront designs "were often not very good, tending to over-engineer things and make designs flexible in areas that didn't need flexibility while being inflexible in areas that did." Big Design Up Front is explicitly labeled an anti-pattern in agile literature. [Ronny Kohavi's research at Microsoft](https://ai.stanford.edu/~ronnyk/ExPThinkWeek2009Public.pdf) on controlled experiments found that roughly one-third of tested features showed statistically significant negative impact, suggesting that locking in architectural decisions before implementation feedback is a gamble.
...
The [2025 Stack Overflow Developer Survey](https://survey.stackoverflow.co/2025/) found that only 29% of developers trust AI accuracy, down from 40% the prior year, while 84% use or plan to use AI tools. Adoption is up. Trust is down. That gap frames the real challenge for BMAD and every tool in this space.
